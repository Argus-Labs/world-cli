...
func (c *Client) Get(ctx context.Context, endpoint string) ([]byte, error) {
	return c.sendRequest(ctx, http.MethodGet, endpoint, nil)
}

// Post performs a POST request to the specified endpoint with a body.
func (c *Client) Post(ctx context.Context, endpoint string, body interface{}) ([]byte, error) {
	return c.sendRequest(ctx, http.MethodPost, endpoint, body)
}

// Put performs a PUT request to the specified endpoint with a body.
func (c *Client) Put(ctx context.Context, endpoint string, body interface{}) ([]byte, error) {
	return c.sendRequest(ctx, http.MethodPut, endpoint, body)
}
...
func (c *Client) Delete(ctx context.Context, endpoint string) ([]byte, error) {
	return c.sendRequest(ctx, http.MethodDelete, endpoint, nil)
}
...
// ParseResponse parses a JSON response body into the provided result.
func (c *Client) ParseResponse(body []byte, result interface{}) error {
	...
	if err := json.Unmarshal([]byte(dataResult.Raw), result); err != nil {
