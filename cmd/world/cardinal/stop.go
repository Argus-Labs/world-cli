...
- Redis (Cardinal dependency)`,
	RunE: func(cmd *cobra.Command, _ []string) error {
		...
		err = dockerClient.Stop(cmd.Context(), service.Nakama, service.Cardinal, service.NakamaDB, service.Redis, service.OtelCollector, service.Jaeger, service.Prometheus)
		if err != nil {
			return err
		}
