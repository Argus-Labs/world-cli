...
func (h *Handler) getListOfProjects(ctx context.Context) ([]models.Project, error) {
	selectedOrg, err := h.apiClient.GetOrganizationByID(ctx, h.configClient.GetConfig().OrganizationID)
...
func (h *Handler) getSelectedProject(ctx context.Context) (models.Project, error) {
	...
	if h.configClient.GetConfig().ProjectID == "" {
		projects, err := h.getListOfProjects(ctx)
		if err != nil {
	...
	// Send request
	project, err := h.apiClient.GetProjectByID(ctx, h.configClient.GetConfig().ProjectID)
	if err != nil {
...
func (h *Handler) ProjectPreCreateUpdateValidation() (string, string, error) {
...
func (h *Handler) saveToConfig(project *models.Project) error {
	h.configClient.GetConfig().ProjectID = project.ID
